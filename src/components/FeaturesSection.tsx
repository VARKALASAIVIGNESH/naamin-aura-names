  ...
  const features = [
    {
      ...
      gradient: "from-naamin-bronze to-naamin-gold",
    ...
    },
    {
      ...
      gradient: "from-naamin-gold to-naamin-amber",
    ...
    },
    {
      ...
      gradient: "from-naamin-amber to-naamin-bronze",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-merriweather font-bold text-foreground mb-6">
            Ancient Powers for
            <span className="bg-gradient-to-r from-naamin-bronze to-naamin-gold bg-clip-text text-transparent"> Perfect Names</span>
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group bg-card/80 backdrop-blur-sm rounded-3xl p-8 hover:bg-card hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-2 border-naamin-bronze/30 hover:border-naamin-gold/50 ancient-scroll"
            >
              <div className="flex items-center gap-4 mb-6">
                ...
                <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-naamin-bronze/30">
                  <img 
                    src={feature.image} 
